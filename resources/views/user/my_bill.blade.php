...
<body>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                ...
                <a class="dropdown-item text-primary" href="{{url('my_bill')}}">Tagihanku</a>
              </div>
            </div>
  ...
  <h1><b>Daftar Tagihan Pengunjung</br> di</b></h1>
      ...
      <div>
          <table class="scroll" style="background-color: #c5fcef">
            <tr style="background-color: #00D9A5" align="center">
                <th style="padding: 10px; font-size: 15px; color:white">Nama Pasien</th> 
                <th style="padding: 10px; font-size: 15px; color:white">Nama Dokter</th> 
                <th style="padding: 10px; font-size: 15px; color:white">Tanggal bertemu</th> 
                <th style="padding: 10px; font-size: 15px; color:white">Waktu bertemu</th> 
                <th style="padding: 10px; font-size: 15px; color:white">Jumlah Tagihan*</th> 
                <th style="padding: 10px; font-size: 15px; color:white">Tenggat Tagihan</th>
            ...
            <tr align="center">
                ...
                <td>{{$bills->time}}</td>
                <td>{{$bills->bill}}</td>
                <td>{{$bills->lastdate}}</td>
                <td><i>{{$bills->status}}</i></td>
            </tr>   
            @endforeach      
        </table>
        <i class="text-grey" style="text-align:left">*Jumlah tagihan dan nomor tujuan pembayaran tagihan akan dikirim melalui email, mohon periksa  <br>email anda secara berkala.</i>
      </div>
  </div>
